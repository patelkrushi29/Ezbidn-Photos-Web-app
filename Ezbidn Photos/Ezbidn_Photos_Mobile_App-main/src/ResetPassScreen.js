...
const ResetPassScreen = ({ route }) => {
    ...
    const { fetchEmail } = route.params;
    const { getVerificationID } = route.params;
    ...
    const handleResetPassword = async () => {
        ...
        setIsLoading(true);
        const response = await resetPassword(getVerificationID, fetchEmail, newPassword);
        if (response) {
            setIsLoading(false);
        ...
        >
            ...
            >
                <View style={styles.container}>
                    ...
                    <Text style={styles.subtitle}>Enter your new password and confirm the new password to reset password</Text>
